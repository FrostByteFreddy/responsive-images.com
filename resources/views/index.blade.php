                ...
                <div class="card shadow-lg">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div id="focal-point-area" class="border rounded mb-3" style="position: relative; line-height: 0;">
                            <img id="image-preview" src="" alt="Image preview" class="rounded" style="max-width: 100%;max-height: 80vh;margin: auto;display: block;padding: 1rem;">
                ...
                <div class="card shadow-lg">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="base_path_config" value="" placeholder="e.g., /assets/images/">
